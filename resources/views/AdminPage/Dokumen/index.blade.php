                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="dokumen-table" class="display table table-striped table-hover">
                                    <thead>
                                        <tr>
                                            <th>No</th>
                                            <th>Nama Dokumen</th>
                                            ...
                                            <tr>
                                               ...
                                               <td>
                                                ...
                                                <td>
                                                    @if ($document->files)
                                                        @php
                                                            $files = json_decode($document->files); // Mendecode JSON menjadi array
                                                        @endphp
                                                ...
                                                <td>
                                                    <span
                                                        class="badge {{ $document->status_document == 1 ? 'badge-success' : 'badge-danger' }}">
                                                        {{ $document->status_document == 1 ? 'Aktif' : 'Tidak Aktif' }}
                                                    </span>
                                                </td>
                                                <td>
                                            ...
                                            <div class="modal fade" id="statusModal{{ $document->id }}" tabindex="-1"
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <form action="{{ route('document.toggleStatus', $document->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="form-group">
                                                                    <label>Status</label>
                                                                    <select name="status_document" class="form-control">
                                                                        <option value="1"
                                                                            {{ $document->status_document == 1 ? 'selected' : '' }}>
                                                                            Aktif
                                                                        </option>
                                                                        <option value="2"
                                                                            {{ $document->status_document == 2 ? 'selected' : '' }}>
                                                                            Tidak Aktif
                                                                        </option>
                                                                    </select>
                                                                </div>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    @if ($document->files)
                                                                        <div class="mt-3">
                                                                            ...
                                                                            <ul>
                                                                                @foreach (json_decode($document->files, true) as $file)
                                                                                    <li>
